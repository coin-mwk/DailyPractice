				...
				<div id="content">
					<div class="login_form">
						<div class="login_box">
							<div class="tit">
								<h1>注册尚硅谷会员</h1>
								<span class="errorMsg">${empty requestScope.errmsg ? "" : requestScope.errmsg }</span>
							</div>
							<div class="form">
								<form action="userServlet" method="post">
									...
									<br />
									<label>验证码：</label>
									<input class="itxt" type="text" style="width: 150px;" name="code" id="code" value="${requestScope.code}"/>
